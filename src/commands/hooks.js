 ...
 *     prompt and, worse, teaches them to uninstall. wife failing is always
 *     better than wife being noisy.
...
export async function cmdInject(args) {
  ...
  if (args.verbose) process.stderr.write(`wife: injected ${tokens} tokens\n`);
  return 0;
}

/**
 * `wife capture` — UserPromptSubmit.
...
/**
 * `wife harvest` — SessionEnd, or run by hand.
