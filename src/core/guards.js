...
import { wifeHome } from '../util/paths.js';
 ...
 *   asked to block is far worse than not blocking one they did. `wife harden`
...
const guardsPath = () => path.join(wifeHome(), 'guards.json');
