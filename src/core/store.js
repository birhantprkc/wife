 ...
 * open it in any editor and rewrite it; wife reads your edits back and keeps
...
export class Store {
  ...
  render() {
    ...
    const all = this.facts();
    if (!all.length) {
      lines.push('_Empty. Add a line with `wife remember "..."`, or just type bullets under a `##` heading below._', '');
